...
import { movies, allGenres, Movie } from '@movies/data/movies';
import { WatchlistProvider } from '@movies/contexts/WatchlistContext';
import { AuthProvider } from '@movies/contexts/AuthContext';
