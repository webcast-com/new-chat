      ...
      <header className="sticky top-0 z-50 bg-[#0d1117]/95 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-3 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex min-w-0 items-center gap-2 cursor-pointer sm:gap-3" onClick={() => navigate('/')}>
              ...
              <div className="min-w-0">
                ...
                <p className="hidden text-[10px] -mt-0.5 tracking-widest uppercase text-[rgb(141,197,255)] sm:block">Live Sports · Phase 5</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1">
              <button onClick={() => setSearchOpen(!searchOpen)} aria-label="Search" className="md:hidden p-2 rounded-xl bg-white/5 text-gray-400 hover:text-white hover:bg-white/10">
                <Search className="w-5 h-5" />
              </button>

              {/* Language dropdown - Phase 5: 5 languages */}
              <div className="relative" ref={langRef}>
                <button onClick={() => setLangMenuOpen(!langMenuOpen)} aria-label="Change language" className="p-2 rounded-xl bg-white/5 text-gray-400 hover:text-white hover:bg-white/10 transition-all flex items-center gap-1">
              ...
              <button onClick={handleNotificationToggle} aria-label="Notifications" className={`relative p-2 rounded-xl transition-all ${canNotify ? 'bg-green-500/10 border border-green-500/20 text-green-400' : 'bg-white/5 text-gray-400 hover:text-white hover:bg-white/10'}`} title={canNotify ? 'Notifications ON - Phase 5' : 'Enable notifications'}>
              ...
              <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Menu" className="lg:hidden p-2 rounded-xl bg-white/5 text-gray-400 hover:text-white hover:bg-white/10">
