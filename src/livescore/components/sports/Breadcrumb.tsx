...
function getBreadcrumbs(activeTab: MainTab, activeSport?: Sport): Array<{ label: string; href?: string }> {
...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ activeTab, activeSport, onNavigate }) => {
  const breadcrumbs = useMemo(() => getBreadcrumbs(activeTab, activeSport), [activeTab, activeSport]);
  ...
  }, [activeTab, activeSport, breadcrumbs]);
