...
export const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[45] p-4">
      <div className="max-w-4xl mx-auto bg-[#161b22] border border-white/10 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl max-h-[55vh] overflow-y-auto">
        {!showSettings ? (
          <div className="p-6">
