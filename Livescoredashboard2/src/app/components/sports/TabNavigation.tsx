...
import { Radio, Target, Crown, Settings, Webhook, CreditCard, BarChart3, Zap } from 'lucide-react';

export type MainTab = 'dashboard' | 'predictions' | 'results' | 'sure-bets' | 'premium' | 'settings' | 'subscription' | 'webhook';
