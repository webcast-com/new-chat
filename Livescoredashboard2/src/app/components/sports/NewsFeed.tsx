...
const NewsFeed: React.FC = () => {
  const { articles, source, loading } = useNews();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((article) => (
            <article
              key={article.id}
              className="group bg-[#161b22] border border-white/5 rounded-xl overflow-hidden hover:border-[#00d4ff]/20 hover:bg-[#1c2333] transition-all cursor-pointer"
            >
              {/* Image */}
              ...
              <div className="p-5">
                ...
                <h3 className="text-white font-bold text-base mb-2 line-clamp-2 group-hover:text-[#00d4ff] transition-colors">
                  {article.title}
                </h3>
